...
export default {
  ...
  methods: {
    ...
    getCourseList() {
      this.loading = true
      this.data = []
      getCourseList({ type: 1, code: 1, teacher_type: 1, disabled: 1, page_size: this.page_size, page: this.page, course_name: this.course_name, teacher_name: this.teacher, start_time: this.start_time, end_time: this.end_time }).then(res => {
